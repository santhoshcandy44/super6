...
@Composable
fun EditServiceInfoScreen(navHostController: NavHostController, onPopBackStack:()-> Unit,
        ...
        Scaffold(
            topBar = {
                TopAppBar(
                    ...
                    title = {
                        Text(text = "Edit Service Info", style = MaterialTheme.typography.titleMedium)
                    }
                )
            },
            modifier = Modifier
