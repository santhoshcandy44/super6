    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        text = "Phone", // Set your title text here
            ...
            Column(
                ...
                Column(modifier = Modifier.wrapContentSize()) {
                    Row(
                        ...
                        Text("Add phone number to QR code", modifier = Modifier.weight(1f))
                    }
                ...
                Column(modifier = Modifier.wrapContentSize()) {
                    ...
                    Button(
                        onClick = {
                            viewModel.generateQrCodeForPhoneNumber(phoneNumber, onSuccess = {
                                Toast.makeText(
                                    context,
                                    "Successfully phone QR code is generated",
                                    Toast.LENGTH_SHORT
                                )
                                    .show()
                            }, onError = {
                                Toast.makeText(
                                    context, "Failed to generate phone QR code",
                                    Toast.LENGTH_SHORT
                                ).show()
