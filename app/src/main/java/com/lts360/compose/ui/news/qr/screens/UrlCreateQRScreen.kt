            ...
            Column(
                ...
                Column(modifier = Modifier.wrapContentSize()) {
                    Row(
                        ...
                        Text("Add title and Url link to QR code", modifier = Modifier.weight(1f))
                    }
                ...
                Column(modifier = Modifier.wrapContentSize()) {
                    ...
                    Button(
                        onClick = {
                            viewModel.generateQrCodeForUrl(title, url, onSuccess = {
                                Toast.makeText(
                                    context,
                                    "Successfully url QR code is generated",
                                    Toast.LENGTH_SHORT
                                ).show()
                            }, onError = {
                                Toast.makeText(
                                    context, "Failed to generate url QR code",
                                    Toast.LENGTH_SHORT
                                ).show()
                            })
                        },
